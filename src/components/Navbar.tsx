  ...
  return (
    <div className="text-white/70 pt-6">
      ...
      <div className="hidden md:flex items-center px-4 py-2 mx-auto max-w-[400px]">
        <ul className="flex flex-row font-bold p-4 space-x-8">
      ...
      <div
        onClick={toggleNav}
        className="md:hidden absolute top-5 right-5 text-white/70 p-2 z-50"
      >
      ...
      {nav && <div className="fixed inset-0 z-30 backdrop-blur-md"></div>}
    </div>
  );
};
