        ...
        <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"></div>
          <div className=" flex flex-row p-6">
            ...
            <div className="flex flex-col mt-4">
              ...
              <p className="text-lg text-white/70 mt-2">I have Bechlor and Master Degree In Computer Applications
                i am focusing on Technologies like MERN specially on React , Nextjs and tailwind</p>
            </div>
          </div>
        </div>
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"></div>
          <div className=" flex flex-row p-6">
            ...
            <div className="flex flex-col mt-4">
              ...
              <p className="text-lg text-white/70 mt-2">I Have Decent Portfolio Of Projects</p>
            </div>
          </div>
        </div>
        <div className="w-full md:col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"></div>
          <div className=" flex flex-row p-6">
            ...
            <div className="flex flex-col mt-4">
              ...
              <p className="text-lg text-white/70 mt-2">C, Java ,Html , CSS , JS , React , Nextjs , TailwindCSS , Nodejs , Express , SQL , Bootstrap , MongoDB </p>
            </div>
          </div>
        </div>
